...
import { Facebook, Instagram, Youtube, Twitter, TextIcon as Telegram, PhoneIcon as WhatsApp } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/artists" className="hover:text-purple-500">Artists</Link></li>
              <li><Link to="/portfolio" className="hover:text-purple-500">Portfolio</Link></li>
              <li><Link to="/account" className="hover:text-purple-500">Account</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link to="#" className="w-10 h-10 border border-gray-700 rounded-full flex items-center justify-center hover:border-purple-500 hover:text-purple-500">
                <Facebook size={20} />
              </Link>
              <Link to="#" className="w-10 h-10 border border-gray-700 rounded-full flex items-center justify-center hover:border-purple-500 hover:text-purple-500">
                <Instagram size={20} />
