               ...
               {session.isSignedIn ?
                  (
                     <div className="mt-6 flex flex-col space-y-4">
                        ...
                        <Link to={"#"} onClick={signOut} className="flex items-center space-x-2 text-gray-600 hover:text-gray-900">
                           <LogOut size={20} />
                           <span>Sign out</span>
                        </Link>
                     </div>) :
                  (
                     <div className="mt-6 flex flex-col space-y-4">
                        <Link to="sign-in" className="flex items-center space-x-2 text-gray-600 hover:text-gray-900">
                           <LogIn size={20} />
                           <span>Sign in</span>
                        </Link>
                        <Link to="/waitlist" className="flex items-center space-x-2 text-gray-600 hover:text-gray-900">
                           <BookCheck size={20} />
                           <span>Waitlist</span>
                        </Link>
                     </div>
   ...
   return (
      <div className="hidden md:flex items-center w-full">
         ...
         <div className="group ml-5">
            <Button variant="ghost" className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900 px-1">
               <User className="-mr-1" />
               <span>Account</span>
            ...
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out z-50">
               <div className="py-1">
                  ...
                  <Link to={"#"} onClick={signOut} className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                     <LogOut size={20} />
...
const Anonymous = () => {
   return (
      <div className="hidden md:flex items-center justify-end">
         <Link to="/sign-in" className="flex items-center w-20 space-x-1 text-sm font-medium text-gray-600 hover:text-gray-900">
            <LogIn size={20} />
            <span>Sign In</span>
         </Link>
         <div className="w-3" />
         <Link to="/waitlist" className="flex items-center w-28 space-x-1 text-sm font-medium text-gray-600 hover:text-gray-900">
            <BookCheck size={20} />
